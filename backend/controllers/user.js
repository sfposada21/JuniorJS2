...
const registerUser = async (req, res) => {
  if (!req.body.FirstName || !req.body.LastName || !req.body.user || !req.body.email || !req.body.password)
...
const updateUser = async (req, res) => {
  if (!req.body._id || !req.body.user || !req.body.email || !req.body.roleId || !req.body.FirstName || !req.body.LastName)
    return res.status(400).send("Informacion incompleta");
